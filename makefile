...
g++ main.cpp data_source/data_source.cpp server/iserver.cpp server/server.cpp new_publisher/ipublisher.cpp new_publisher/udp_publisher.cpp  connection/tcp_connection.cpp connection/udp_connection.cpp -g -o main.out -L../lib -lXYData -lpthread
